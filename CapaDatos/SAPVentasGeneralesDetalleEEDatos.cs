...
namespace CapaDatos
{
    public class SAPVentasGeneralesDetalleEEDatos
    {
        ...
        public SAPVentasGeneralesDetalleEEDatos()
        {
            try
            {
        ...
        public DataTable VentasGeneralesDetalladaSAPEEDT(DateTime fecha1, DateTime fecha2, string Canal)
        {
            ...
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandTimeout = 0;
                cmd.CommandText = "SBO_ACSA_PROD.ACSA_VTAS_WEB_VentaGCxDetalladaProductoEE";
