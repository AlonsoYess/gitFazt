...
namespace CapaDatos
{
    public class SAPVentasGeneralesDetalleDatos
    {
        ...
        public SAPVentasGeneralesDetalleDatos()
        {
            try
            {
        ...
        public DataSet VentasGeneralesDetalladaSAPDS(DateTime fecha1, DateTime fecha2, string Canal)
        {
        ...
        public DataTable VentasGeneralesDetalladaSAPDT(DateTime fecha1, DateTime fecha2, string Canal)
        {
