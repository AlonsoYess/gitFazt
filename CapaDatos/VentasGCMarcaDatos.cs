...
namespace CapaDatos
{
    public class VentasGCMarcaDatos
    {
        ...
        public DataTable VentasGCMarcaListarCDatos(DateTime fecha1, DateTime  fecha2,string Empresa)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "pa_VentasMensualesGCMarca2";
            ...
            return (dts.Tables["VentaGCMarca"]);
        }
