...
namespace CapaDatos
{
    public class SAPVentasGCPuntoDetalleDatos
    {
        ...
        {           
            ...
            DataTable dt = new DataTable();
             try
             {
                ...
                // Parametro Vendedor.
                pv = cmd.CreateParameter();
                pv.HanaDbType = HanaDbType.VarChar;
