<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SAPVentasXArticuloExcel.aspx.cs" Inherits="CapaPresentacion.SAPVentasXArticuloExcel" %>
...
<body>
    ...
    <div class="auto-style40">
        ...
        <br />
        VENTAS EN GENERAL -&nbsp; DETALLADAS POR ARTÍCULO<br />
        ...
        <table class="auto-style62">
            <tr>
                ...
                <td class="auto-style69"><strong><span class="auto-style4">
                    ...
                    <span class="auto-style11">
                    <asp:TextBox ID="txtFechaInicial" runat="server" CssClass="auto-style53" Width="120px" TextMode="Date">01/11/2018</asp:TextBox>
        </span>
        </span>
            </span>
        </strong>
            ...
            <tr>
                ...
                <td class="auto-style43"><strong>
                    <asp:TextBox ID="txtFechaFinal" runat="server" CssClass="auto-style53" Width="120px" TextMode="Date">30/11/2018</asp:TextBox>
                    </strong>
                </td>
