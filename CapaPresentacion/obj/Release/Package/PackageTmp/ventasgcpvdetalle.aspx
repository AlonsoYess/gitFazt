<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ventasgcpvdetalle.aspx.cs" Inherits="CapaPresentacion.ventasgcpvdetalle" %>
...
&nbsp;Hasta
        ...
        <asp:GridView ID="GridPuntoyVendedor" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="auto-style3" Width="1000px" HorizontalAlign="Right"  ShowFooter="True" OnRowDataBound="GridPuntoyVendedor_RowDataBound" OnSelectedIndexChanged="GridPuntoyVendedor_SelectedIndexChanged" ForeColor="#333333" GridLines="None">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Vendedor" HeaderText="Cod.Ven." />
                <asp:BoundField DataField="VenDes" HeaderText="Vendedor" />
                <asp:BoundField DataField="RUC" HeaderText="RUC" />
                <asp:BoundField DataField="RazonSocial" HeaderText="Razon Social" />
                <asp:BoundField DataField="GcFacFecEm" DataFormatString="{0:d}" HeaderText="Fecha" />
