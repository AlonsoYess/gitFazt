...
{
    public partial class cotizaciondetcliente : System.Web.UI.Page

    {
        CotizacionDetNegocio CotizacionDetNego = new CotizacionDetNegocio();
        CotizacionDetEntidad CotizacionDetEnti = new CotizacionDetEntidad();
        ...
        {
            cot = Request.QueryString["datos1"];
            emp = Request.QueryString["datos2"];
            doc = Request.QueryString["datos3"];
        ...
        private void ListarDatos()
        {
            ...
            {   //tab = CotizacionNego.CotizacionConsultar(cliente);
                grdClientes.DataSource = CotizacionDetNego.CotizacionDetConsultar(cot, emp, doc);
