<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ventasgcmarca.aspx.cs" Inherits="CapaPresentacion.ventasgcmarca" %>
...
<body>
    ...
    <div class="auto-style40">
        ...
        <span class="auto-style1"><strong><span class="auto-style41">VENTAS GRUPO CORPORATIVO X MARCA - NO INCLUYE IGV - SOLES</span><span class="auto-style13"><br />
        </span></strong></span><br class="auto-style44" />
        ...
        <table align="left" class="auto-style32">
            <tr>
                ...
                <td class="auto-style33" colspan="6">
            ...
            <tr>
                ...
                <td class="auto-style22">
                    <strong>
                    <asp:TextBox ID="txtFecha1" runat="server" CssClass="auto-style26" Width="160px" OnTextChanged="txtFecha1_TextChanged" TextMode="Date">01/11/2018</asp:TextBox>
                    </strong>
                </td>
            ...
            <tr>
                ...
                <td class="auto-style38">
                    ...
                    <asp:TextBox ID="txtFecha2" runat="server" CssClass="auto-style26" Width="160px" TextMode="Date">30/11/2018</asp:TextBox>
            </span>
        </strong>
                </td>
        ...
        <span class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style38">
                    <asp:DropDownList ID="ddEmpresa" runat="server" CssClass="auto-style26" Height="17px" Width="165px">
        ...
        <table align="left" class="auto-style5">
            <tr class="auto-style12">
                ...
                <td class="auto-style31"><span class="auto-style42">
                    ...
                    <span class="auto-style11">
        <asp:GridView ID="GridVentasGCMarca" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="auto-style3" Width="100%" HorizontalAlign="Right"   OnRowDataBound="GridVentasGCMarca_RowDataBound"  ShowFooter="True" ForeColor="#333333" GridLines="None">
