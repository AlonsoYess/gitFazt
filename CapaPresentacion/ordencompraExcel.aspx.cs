...
{
    public partial class ordencompraExcel : System.Web.UI.Page
    {
        OrdenCompraNegocio OrdenCompraNego = new OrdenCompraNegocio();
        OrdenCompraEntidad OrdenCompraEnti = new OrdenCompraEntidad();
        ...
        private void ComprasExportarExcel()
        {
            ...
            ew1.Cells["A1"].LoadFromDataTable(OrdenCompraNego.OrdenCompraDT(Convert.ToDateTime(txtFecha1.Text),Convert.ToDateTime(txtFecha2.Text), ddlListEmp.SelectedValue  ), true);
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                Fecha = Fecha.AddDays(-1 * DateTime.Now.Day + 1);
                txtFecha1.Text = Fecha.ToString("yyyy-MM-dd");
            }
            ListarCompras();
        ...
        protected void btnVentaPBuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script language=javascript>alert('Error : No Tienes Acceso a Ver Consulta - Compras');</script>");
                /* Response.Redirect("sico.aspx");*/
            }
