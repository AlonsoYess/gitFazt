...
namespace CapaPresentacion
{
    ...
    public partial class ventasgcformapago : System.Web.UI.Page
    {
        VentasGCFormaPagoNegocio VentasGCNego = new VentasGCFormaPagoNegocio();
        VentasGCFormaPagoEntidad VentasGCEnti = new VentasGCFormaPagoEntidad();
        ...
        private void VentasGCListarPL()
        {
            try
            {
                GridVentasGCFormaPago.DataSource = VentasGCNego.VentasGCFormaPagoListarCDatos(Convert.ToDateTime(txtFecha1.Text),Convert.ToDateTime(txtFecha2.Text),ddEmpresa.Text);
                GridVentasGCFormaPago.DataBind();
            }
            catch (Exception)
            {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((OpcionEnti.tbValor == 0))
            {
                ...
                Response.Write("<script language=javascript>alert('Error : No Tienes Acceso  - VentasGCFP');window.location.href ='menup.aspx';</script>");
            }
        ...
        protected void GridVentasGCMarca_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                suma7 = suma7 + Convert.ToDouble(e.Row.Cells[8].Text);
            }
            else
            {
                if (e.Row.RowType == DataControlRowType.Footer)
                {
                    ...
                    e.Row.Cells[8].Text = suma7.ToString("N");
                    e.Row.Cells[8].HorizontalAlign = HorizontalAlign.Right;
