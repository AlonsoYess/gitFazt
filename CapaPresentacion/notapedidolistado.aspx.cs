...
namespace CapaPresentacion
{
        ...
        public partial class notapedidolistado : System.Web.UI.Page

    {
        NotaPedidoListadoNegocio NotaPedidoListadoNego = new NotaPedidoListadoNegocio();
        NotaPedidoListadoEntidad NotaPedidoListadoEnti = new NotaPedidoListadoEntidad();
            ...
            private void ListarDatos()
        {
            ...
            try
            {
                ...
                grdClientesCotiz.DataSource = NotaPedidoListadoNego.NotaPedidoListadoConsultarDT(Convert.ToDateTime(txtFecha1.Text), Convert.ToDateTime(txtFecha2.Text) , ddlAlmacen.Text , txtNotaPedido.Text );
    ...
    /*    private void FacturaListadoExcel()
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            ew1.Cells["A1"].LoadFromDataTable(NotaPedidoListadoNego.NotaPedidoListadoConsultarDT(Convert.ToDateTime(txtFecha1.Text), Convert.ToDateTime(txtFecha2.Text), ddlAlmacen.Text, txtNotaPedido.Text), true);
