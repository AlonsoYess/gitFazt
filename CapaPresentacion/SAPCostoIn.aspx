<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SAPCostoIn.aspx.cs" Inherits="CapaPresentacion.SAPCostoIn" %>
...
<body>
    ...
    <div class="auto-style40">
        ...
        <table class="auto-style62">
            <tr>
                ...
                <td class="auto-style69"><strong><span class="auto-style4">
                    ...
                    <asp:TextBox ID="txtFechaInicial" runat="server"  CssClass="auto-style53" Width="120px" TextMode="Date">01/06/2019
</asp:TextBox>
        </span>
        </span>
            </span>
        ...
        <asp:Button ID="btnVentaPBuscar" runat="server" OnClick="btnVentaPBuscar_Click" Text="Archivo en Excel [ SAP]" CssClass="auto-style49" Width="331px" Font-Bold="True" BorderColor="#003399" BorderStyle="Solid" style="height: 26px" />
                    </strong></td>
            </tr>
            <tr>
                ...
                <td class="auto-style61">
                    <asp:DropDownList ID="ddlList" runat="server" CssClass="auto-style60" Font-Bold="True" Height="22px" Width="125px">
                        <asp:ListItem Value="0">Total</asp:ListItem>
                        <asp:ListItem Value="7010101">PDV</asp:ListItem>
                        <asp:ListItem Value="7010103">MAYORISTAS</asp:ListItem>
                        <asp:ListItem Value="7010104">RETAIL</asp:ListItem>
                        <asp:ListItem Value="7010102">CORPORATIVOS</asp:ListItem>
                        <asp:ListItem Value="7010105">PROYECTOS-INGENIERIA</asp:ListItem>
                    </asp:DropDownList>
                    </td>
            ...
            <tr>
                ...
                <td class="auto-style48"><strong>&quot;0&quot; Para Todos los Clientes</strong></td>
            </tr>
            <tr>
