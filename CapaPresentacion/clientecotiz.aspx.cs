...
{
    public partial class clientecotiz : System.Web.UI.Page

    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            OpcionEnti = OpcionNego.OpcionConsultar(Session["rusiausuario"].ToString(), "clientecotiz");
            if ((OpcionEnti.tbValor == 0))
            {

                Response.Write("<script language=javascript>alert('Error : No Tienes Acceso - Cotizacion de Clientes');window.location.href ='menup.aspx';</script>");
            }
        }
        ...
        private void ListarDatos()
        {
            ...
            {   tab = ClienteNego.ClienteConsultar(txtDato.Text);
                grdClientesCotiz.DataSource = ClienteNego.ClienteConsultar(txtDato.Text);
