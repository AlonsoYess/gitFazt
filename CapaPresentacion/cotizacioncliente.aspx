<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cotizacioncliente.aspx.cs" Inherits="CapaPresentacion.cotizacioncliente" %>
...
<body>
    ...
    <div class="auto-style13">
        ...
        <table align="left" class="auto-style12">
            ...
            <span class="auto-style43"><strong>LISTADO DE COTIZACIONES Y NOTAS DE PEDIDO</strong></span><strong><br class="auto-style40" />
                    <span class="auto-style43">
            RUC Cliente&nbsp; : <asp:Label ID="Label1" runat="server" Text="Label" CssClass="auto-style42"></asp:Label>
            &nbsp;Razon Social :&nbsp;
                ...
                <td class="auto-style19" colspan="3">
                    <asp:GridView ID="grdClientes" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="auto-style28" ForeColor="#333333" GridLines="None" HorizontalAlign="Left" Width="900px" OnSelectedIndexChanged="grdClientes_SelectedIndexChanged" OnRowDataBound="grdClientes_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="Cod" HeaderText="CodVen" />
                            ...
                            <asp:BoundField DataField="Imp" DataFormatString="{0:###,###.00}" HeaderText="Importe" />
                            <asp:CommandField HeaderText="Detalle" SelectText="Ver Detalle" ShowSelectButton="True">
